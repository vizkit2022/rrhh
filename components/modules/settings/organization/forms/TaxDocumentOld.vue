  ...
  <div class="containerSection">
    ...
    <div class="containerSection__table">
      ...
      >
        ...
        <div class="col avatar" :class="doc.select ? 'selected' : ''" style="padding: 0 12px;">
        ...
        <div class="col last center" :class="doc.select ? 'selected' : ''">
          <button
            ...
            "
          >
            <span class="u u-percentage"></span>
          </button>
        </div>
      </div>
      <div
...
.containerSection__table-item {
  ...
  height: 52px;
  display: grid;
  grid-template-columns: 48px minmax(237.5px, 2fr) minmax(90px, 1fr) minmax(200px, 2fr) minmax(158px, 1.5fr) 100px
}
