...
const getTotalPermissionByModule = (op) => {
  ...
  const module = permissionStore.permissionsUser.find(
...
<template>
  <div class="permission__system">
    <button
      ...
      :key="option.prop"
      @click="option.activate = !option.activate; permissionStore.modalPermissions.change = true"
      :disabled="!permissionStore.modalPermissions.edit || option.code === 'projects_global'"
    >
