...
onMounted(async () => {
  ...
  await salesStore.getSalesDocumentLinesByDocumentId(idSale);
...
<template>
  <div class="container_sales">
    <div class="header_sales"></div>
    <div class="table_wrapper">
      <TableBasic
        :content="salesStore.sale.lines"
        :configTable="salesStore.saleDocumentType === 'credit' ? configTable.salesNotesCredit : configTable.salesNotesDebit"
      >
    ...
    <div class="taxes">
      ...
      <div class="taxes__list">
        ...
        >
          <span>{{ t(module + ".tableTotalTaxes.msg.emptyTax") }}</span>
        </div>
      </div>

      <div class="taxes__default tax">
        <div class="taxes__default-col first">
          <span>{{ t(module + ".tableTotalTaxes.taxes") }}</span>
        </div>
      ...
      <div class="taxes__default">
        <div class="taxes__default-col first">
          <span>{{ t(module + ".tableTotalTaxes.retentions") }}</span>
        </div>
        <div class="truncateText colFXR right">
          <span class="truncateText">{{
      ...
      <div class="taxes__footer">
        <div class="taxes__footer-col first">
          <span>{{ t(module + ".tableTotalTaxes.total") }}</span>
        </div>
